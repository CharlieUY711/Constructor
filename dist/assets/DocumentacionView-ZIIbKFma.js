import{c as R,r as t,P as D,a as H,t as F,j as e,g as U}from"./index-CD55XL7Y.js";import{O}from"./OrangeHeader-B_SQ0wGW.js";import{B as v}from"./book-open-CZf6ZbI5.js";import{Z as L}from"./zap-ArFdFQid.js";import{U as N}from"./users-imwlV51N.js";import{G as _}from"./globe-xnuWtThM.js";import{S as $}from"./shield-DoytqOUT.js";import{L as G}from"./lock-B5Uo2ozP.js";import{C as W}from"./chevron-right-CG1yhuEC.js";import{C as q}from"./clock-Bgw6e7vN.js";import{P as Y}from"./pen-CKo-jan1.js";import{X as K}from"./x-B9xld54X.js";import{S as Q}from"./save-CtIWHD-V.js";import{T as J}from"./triangle-alert-CDv7Fh-B.js";import{T as Z}from"./tag-C3SwHVf1.js";import"./ConnectionStatusIcon-ClHG-PYF.js";import"./index-yKjPlrCh.js";import"./lightbulb-HC9bD7eJ.js";import"./map-pin-neawR9JO.js";/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const X=[["polyline",{points:"16 18 22 12 16 6",key:"z7tu5w"}],["polyline",{points:"8 6 2 12 8 18",key:"1eg1df"}]],P=R("code",X);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ee=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M12 7v5l4 2",key:"1fdv2h"}]],y=R("history",ee),s="#FF6835",j=[{id:"introduccion",label:"Introducción & Overview",icon:v,color:s,tecnica:!1,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Release inicial de documentación oficial."},{version:"v1.4.0",date:"15 Ene 2026",author:"Carlos M.",summary:"Actualización de módulos de marketing."}],content:`# Charlie Marketplace Builder v1.5
...
`},{id:"guia-inicio",label:"Guía de inicio rápido",icon:L,color:"#10B981",tecnica:!1,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"María G.",summary:"Guía completa para nuevos usuarios."}],content:`# Guía de Inicio Rápido
...
`},{id:"modulos",label:"Módulos del sistema",icon:D,color:"#3B82F6",tecnica:!1,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Documentación de los 68 módulos activos."}],content:`# Módulos del Sistema
...
`},{id:"integraciones-doc",label:"Integraciones & Pasarelas",icon:H,color:"#14B8A6",tecnica:!1,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Guía de integraciones disponibles."}],content:`# Integraciones & Pasarelas de Pago
...
`},{id:"faq",label:"Preguntas frecuentes",icon:N,color:"#8B5CF6",tecnica:!1,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"María G.",summary:"FAQ inicial del sistema."}],content:`# Preguntas Frecuentes
...
`},{id:"arquitectura",label:"Arquitectura del sistema",icon:P,color:"#1F2937",badge:"Técnico",tecnica:!0,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Documentación arquitectura v1.5."},{version:"v1.4.0",date:"15 Ene 2026",author:"Carlos M.",summary:"Migración a Supabase Edge Functions."}],content:`# Arquitectura del Sistema
...
`},{id:"api-endpoints",label:"API & Endpoints",icon:_,color:"#3B82F6",badge:"Técnico",tecnica:!0,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Documentación de endpoints v1.5."}],content:`# API & Endpoints
...
\`\`\`
`},{id:"auth-config",label:"Autenticación & Roles",icon:$,color:"#7C3AED",badge:"Técnico",tecnica:!0,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Config de Supabase Auth + roles."}],content:`# Autenticación & Configuración de Roles
...
`},{id:"changelog",label:"Changelog & Versiones",icon:y,color:"#F59E0B",badge:"Técnico",tecnica:!0,currentVersion:"v1.5.0",lastModified:"21 Feb 2026",versions:[{version:"v1.5.0",date:"21 Feb 2026",author:"Carlos M.",summary:"Release v1.5 — Nuevos módulos y correcciones."}],content:`# Changelog & Versiones
...
`}];function Se({onNavigate:oe}){const[S,B]=t.useState("usuario"),[C,A]=t.useState("introduccion"),[p,l]=t.useState(!1),[g,f]=t.useState(""),[b,x]=t.useState(!1),[h,M]=t.useState(j),[u,z]=t.useState("tecnico"),E=h.filter(o=>S==="tecnica"?o.tecnica:!o.tecnica),i=h.find(o=>o.id===C)??E[0]??h[0],w=()=>{f(i.content),l(!0),x(!1)},T=t.useCallback(()=>{const a=new Date().toLocaleDateString("es-UY",{day:"2-digit",month:"short",year:"numeric"});M(m=>m.map(r=>{if(r.id!==i.id)return r;const n=r.currentVersion.replace("v","").split("."),c=parseInt(n[2]||"0")+1,d=`v${n[0]}.${n[1]}.${c}`;return{...r,content:g,lastModified:a,currentVersion:d,versions:[{version:d,date:a,author:"SuperAdmin",summary:"Edición manual desde el módulo de documentación."},...r.versions]}})),l(!1),F.success("Documentación guardada",{description:`Sección "${i.label}" actualizada con nueva versión.`})},[i,g]),I=()=>{l(!1),f("")},V=o=>o.replace(/^### (.+)$/gm,'<h3 style="font-size:0.95rem;font-weight:700;color:#1A1A2E;margin:18px 0 8px;">$1</h3>').replace(/^## (.+)$/gm,'<h2 style="font-size:1.1rem;font-weight:800;color:#1A1A2E;margin:22px 0 10px;padding-bottom:6px;border-bottom:2px solid #F3F4F6;">$2</h2>').replace(/^# (.+)$/gm,'<h1 style="font-size:1.35rem;font-weight:900;color:#1A1A2E;margin:0 0 18px;">$1</h1>').replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/`([^`]+)`/g,'<code style="background:#F3F4F6;padding:2px 6px;border-radius:4px;font-size:0.82em;font-family:monospace;color:#374151;">$1</code>').replace(/```[\w]*\n?([\s\S]*?)```/g,'<pre style="background:#1F2937;color:#E5E7EB;padding:16px;border-radius:10px;font-size:0.78rem;overflow-x:auto;line-height:1.6;margin:14px 0;">$1</pre>').replace(/^\| (.+) \|$/gm,a=>"<tr>"+a.split("|").filter(r=>r.trim()&&!r.match(/^[-\s]+$/)).map(r=>`<td style="padding:6px 12px;border:1px solid #E5E7EB;font-size:0.8rem;">${r.trim()}</td>`).join("")+"</tr>").replace(/^- (.+)$/gm,'<li style="font-size:0.85rem;color:#374151;margin:5px 0;line-height:1.5;">$1</li>').replace(/(<li[^>]*>.*<\/li>\n?)+/g,'<ul style="margin:10px 0 10px 20px;padding:0;">$&</ul>').replace(/\n\n/g,'</p><p style="margin:0 0 12px;font-size:0.85rem;color:#374151;line-height:1.6;">').replace(/^(?!<[hupltc])/gm,"").replace(/⚠️/g,'<span style="color:#F59E0B;">⚠️</span>');return e.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%",overflow:"hidden",backgroundColor:"#F8F9FA"},children:[e.jsx(O,{icon:v,title:"Documentación",subtitle:"Charlie Marketplace Builder v1.5 · Manual técnico y de usuario",rightSlot:e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx("span",{style:{fontSize:"0.72rem",color:"#9CA3AF",fontWeight:"500"},children:"Vista como:"}),["usuario","tecnico"].map(o=>e.jsx("button",{onClick:()=>z(o),style:{padding:"5px 12px",borderRadius:7,border:`1.5px solid ${u===o?s:"#E5E7EB"}`,backgroundColor:u===o?`${s}10`:"#fff",color:u===o?s:"#6B7280",fontSize:"0.75rem",fontWeight:"700",cursor:"pointer"},children:o==="usuario"?"👤 Usuario":"🔧 Técnico"},o))]})}),e.jsx("div",{style:{backgroundColor:"#fff",borderBottom:"1px solid #E5E7EB",padding:"0 28px",display:"flex",gap:0,flexShrink:0},children:[["usuario",v,"Documentación de Usuario","Todos los roles"],["tecnica",P,"Documentación Técnica","Admin · Editor · SuperAdmin"]].map(([o,a,m,r])=>{const n=o===S,c=o==="tecnica"&&u==="usuario";return e.jsxs("button",{onClick:()=>{if(c){F.warning("Solo disponible para Admin, Editor y SuperAdmin");return}B(o),l(!1);const d=j.find(k=>o==="tecnica"?k.tecnica:!k.tecnica);d&&A(d.id)},style:{padding:"14px 22px",border:"none",borderBottom:n?`3px solid ${s}`:"3px solid transparent",backgroundColor:"transparent",color:n?s:c?"#D1D5DB":"#6B7280",fontSize:"0.85rem",fontWeight:n?"800":"600",cursor:c?"not-allowed":"pointer",display:"flex",alignItems:"center",gap:8,transition:"all 0.15s"},children:[c?e.jsx(G,{size:13,color:"#D1D5DB"}):e.jsx(a,{size:14,color:n?s:"#9CA3AF"}),e.jsxs("div",{style:{textAlign:"left"},children:[e.jsx("div",{children:m}),e.jsx("div",{style:{fontSize:"0.68rem",color:"#9CA3AF",fontWeight:"400"},children:r})]})]},o)})}),e.jsxs("div",{style:{flex:1,overflow:"hidden",display:"flex"},children:[e.jsxs("div",{style:{width:240,borderRight:"1px solid #E5E7EB",backgroundColor:"#fff",overflowY:"auto",flexShrink:0},children:[e.jsx("div",{style:{padding:"16px 16px 8px"},children:e.jsx("p",{style:{margin:0,fontSize:"0.68rem",fontWeight:"800",color:"#9CA3AF",textTransform:"uppercase",letterSpacing:"0.08em"},children:"Secciones"})}),E.map(o=>{const a=o.id===C;return e.jsxs("button",{onClick:()=>{A(o.id),l(!1),x(!1)},style:{width:"100%",display:"flex",alignItems:"center",gap:9,padding:"10px 16px",border:"none",backgroundColor:a?`${o.color}10`:"transparent",borderLeft:a?`3px solid ${o.color}`:"3px solid transparent",cursor:"pointer",textAlign:"left",transition:"all 0.12s"},children:[e.jsx(o.icon,{size:14,color:a?o.color:"#9CA3AF"}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("p",{style:{margin:0,fontSize:"0.8rem",fontWeight:a?"700":"500",color:a?o.color:"#374151",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:o.label}),o.badge&&e.jsx("span",{style:{fontSize:"0.62rem",fontWeight:"700",color:"#9CA3AF",backgroundColor:"#F3F4F6",padding:"1px 5px",borderRadius:4},children:o.badge})]}),a&&e.jsx(W,{size:12,color:o.color})]},o.id)})]}),e.jsxs("div",{style:{flex:1,overflowY:"auto",padding:"28px 32px"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:24,gap:16},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12},children:[e.jsx("div",{style:{width:38,height:38,borderRadius:10,backgroundColor:`${i.color}15`,display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx(i.icon,{size:18,color:i.color})}),e.jsxs("div",{children:[e.jsx("h2",{style:{margin:0,fontSize:"1.1rem",fontWeight:"800",color:"#1A1A2E"},children:i.label}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginTop:4},children:[e.jsx("span",{style:{fontSize:"0.7rem",fontWeight:"700",color:i.color,backgroundColor:`${i.color}15`,padding:"2px 8px",borderRadius:5},children:i.currentVersion}),e.jsxs("span",{style:{fontSize:"0.7rem",color:"#9CA3AF",display:"flex",alignItems:"center",gap:3},children:[e.jsx(q,{size:11})," ",i.lastModified]})]})]})]}),e.jsxs("div",{style:{display:"flex",gap:8,flexShrink:0},children:[e.jsxs("button",{onClick:()=>{x(!b),l(!1)},style:{display:"flex",alignItems:"center",gap:6,padding:"8px 14px",borderRadius:8,border:"1.5px solid #E5E7EB",backgroundColor:b?"#F3F4F6":"#fff",color:"#6B7280",fontSize:"0.78rem",fontWeight:"600",cursor:"pointer"},children:[e.jsx(y,{size:13})," Historial"]}),!p&&e.jsxs("button",{onClick:w,style:{display:"flex",alignItems:"center",gap:6,padding:"8px 14px",borderRadius:8,border:"none",backgroundColor:s,color:"#fff",fontSize:"0.78rem",fontWeight:"700",cursor:"pointer"},children:[e.jsx(Y,{size:13})," Editar"]}),p&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{onClick:I,style:{display:"flex",alignItems:"center",gap:6,padding:"8px 14px",borderRadius:8,border:"1.5px solid #E5E7EB",backgroundColor:"#fff",color:"#6B7280",fontSize:"0.78rem",fontWeight:"600",cursor:"pointer"},children:[e.jsx(K,{size:13})," Cancelar"]}),e.jsxs("button",{onClick:T,style:{display:"flex",alignItems:"center",gap:6,padding:"8px 14px",borderRadius:8,border:"none",backgroundColor:"#10B981",color:"#fff",fontSize:"0.78rem",fontWeight:"700",cursor:"pointer"},children:[e.jsx(Q,{size:13})," Guardar"]})]})]})]}),b&&e.jsxs("div",{style:{backgroundColor:"#fff",borderRadius:12,border:"1px solid #E5E7EB",padding:"18px 20px",marginBottom:24},children:[e.jsxs("h3",{style:{margin:"0 0 14px",fontSize:"0.88rem",fontWeight:"700",color:"#111827",display:"flex",alignItems:"center",gap:7},children:[e.jsx(y,{size:15,color:s})," Historial de versiones — ",i.label]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:i.versions.map((o,a)=>e.jsxs("div",{style:{display:"flex",gap:12,alignItems:"flex-start",padding:"10px 0",borderBottom:a<i.versions.length-1?"1px solid #F3F4F6":"none"},children:[e.jsx("span",{style:{fontSize:"0.72rem",fontWeight:"800",color:a===0?s:"#6B7280",backgroundColor:a===0?`${s}15`:"#F3F4F6",padding:"3px 9px",borderRadius:6,flexShrink:0},children:o.version}),e.jsxs("div",{children:[e.jsx("p",{style:{margin:"0 0 2px",fontSize:"0.8rem",color:"#374151",fontWeight:"600"},children:o.summary}),e.jsxs("p",{style:{margin:0,fontSize:"0.7rem",color:"#9CA3AF"},children:[o.author," · ",o.date]})]}),a===0&&e.jsx("span",{style:{marginLeft:"auto",fontSize:"0.65rem",fontWeight:"700",color:"#10B981",backgroundColor:"#D1FAE5",padding:"2px 7px",borderRadius:5},children:"Actual"})]},a))})]}),p?e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:12,padding:"10px 14px",backgroundColor:"#FFFBEB",borderRadius:8,border:"1px solid #FCD34D",display:"flex",alignItems:"center",gap:7},children:[e.jsx(J,{size:14,color:"#F59E0B"}),e.jsx("p",{style:{margin:0,fontSize:"0.78rem",color:"#92400E"},children:"Editando en formato Markdown. Al guardar se creará una nueva versión automáticamente."})]}),e.jsx("textarea",{value:g,onChange:o=>f(o.target.value),style:{width:"100%",minHeight:480,padding:"20px",borderRadius:12,border:`2px solid ${s}40`,fontSize:"0.84rem",lineHeight:"1.7",fontFamily:'"JetBrains Mono", "Fira Code", monospace',color:"#1A1A2E",backgroundColor:"#FAFAFA",outline:"none",resize:"vertical",boxSizing:"border-box"}})]}):e.jsx("div",{style:{backgroundColor:"#fff",borderRadius:14,border:"1px solid #E5E7EB",padding:"28px 32px",lineHeight:"1.7"},dangerouslySetInnerHTML:{__html:V(i.content)}}),!p&&e.jsxs("div",{style:{marginTop:20,display:"flex",justifyContent:"space-between",alignItems:"center",padding:"12px 16px",backgroundColor:"#F9FAFB",borderRadius:10,border:"1px solid #F3F4F6"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:7},children:[e.jsx(U,{size:13,color:"#10B981"}),e.jsxs("span",{style:{fontSize:"0.75rem",color:"#6B7280"},children:["Última actualización: ",e.jsx("strong",{children:i.lastModified})," · Versión ",e.jsx("strong",{children:i.currentVersion})]})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6},children:[e.jsx(Z,{size:12,color:"#9CA3AF"}),e.jsx("span",{style:{fontSize:"0.72rem",color:"#9CA3AF"},children:"Charlie Marketplace Builder · Nivel 1 — Edición manual"})]})]})]})]})]})}export{Se as DocumentacionView};
