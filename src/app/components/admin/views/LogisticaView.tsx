...
const MODULOS: ModuloDef[] = [
  {
    ...
    bg: '#FFF4EC',
    estado: 'proximo',
    tags: ['Árbol', 'Tracking', 'Acuse de recibo', 'Multi-tramo'],
    navSection: 'envios',
  },
  {
    id: 'rutas',
    icon: Map,
    label: 'Rutas',
    description: 'Gestión de rutas standard y personalizadas por proyecto. Asignación automática por geocodificación Google Maps.',
    color: '#6366F1',
    bg: '#EEF2FF',
    estado: 'proximo',
    tags: ['Standard', 'Por proyecto', 'Google Maps', 'Automática'],
  },
  {
    id: 'transportistas',
    icon: Users,
    label: 'Transportistas',
    description: 'Catálogo de carriers y transportistas. Tramos predefinidos para envíos multi-carrier (local + intercity + internacional).',
    color: '#0EA5E9',
    bg: '#F0F9FF',
    estado: 'proximo',
    tags: ['Carriers', 'Tramos', 'Multi-carrier'],
  },
  {
    id: 'produccion',
    icon: Package,
    label: 'Producción',
    description: 'Órdenes de armado orientadas a ruta. BOM (Bill of Materials) para artículos compuestos como canastas y kits.',
    color: '#10B981',
    bg: '#F0FDF4',
    estado: 'proximo',
    tags: ['BOM', 'Kits', 'Por ruta', 'Prioridad'],
  },
  {
    id: 'abastecimiento',
    icon: ShoppingCart,
    label: 'Abastecimiento',
    description: 'Órdenes de compra automáticas por faltantes de stock. MRP para cálculo de componentes necesarios.',
    color: '#F59E0B',
    bg: '#FFFBEB',
    estado: 'proximo',
  ...
  },
  {
    ...
    description: 'Vista geográfica de envíos activos por ruta y estado. Validación de direcciones en tiempo real.',
    color: '#EC4899',
    bg: '#FDF2F8',
    estado: 'proximo',
    tags: ['Google Maps', 'Tiempo real', 'Por ruta'],
  },
];
